<template>
  <ul role="list" class="">
    <li class="sm:w-64 flex flex-col text-center lg:w-auto">
        ...
        <div class="mt-6">
          ...
          <h3 class="mt-1 font-semibold text-gray-900">
            <a :href="product.href">
              ...
              {{ product.name }} {{ $route.params.shoestype }}
            </a>
          </h3>
      ...
      <ul
        role="list"
        class="mt-auto pt-4 pb-4 flex items-center justify-center space-x-3"
      >
        <li
